 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_17, __pyx_t_31, __pyx_t_36, __pyx_t_39, __pyx_t_25, __pyx_t_22, __pyx_t_19, __pyx_t_30, __pyx_t_20, __pyx_t_34, __pyx_t_26, __pyx_t_28, __pyx_t_18, __pyx_t_32, __pyx_t_21, __pyx_t_35, __pyx_t_29, __pyx_t_33, __pyx_t_37, __pyx_t_27, __pyx_t_24, __pyx_t_38, __pyx_t_23)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_epssq_i) lastprivate(__pyx_v_mass_i) lastprivate(__pyx_v_drsoft3) lastprivate(__pyx_v_dz) lastprivate(__pyx_v_dy) lastprivate(__pyx_v_dx) lastprivate(__pyx_v_i) firstprivate(__pyx_v_pi) lastprivate(__pyx_v_pi) lastprivate(__pyx_v_drsoft) schedule(static)
                    #endif /* _OPENMP */
