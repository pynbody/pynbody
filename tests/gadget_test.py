...
def test_construct(snap):
    ...
    assert snap.filename == "testdata/gadget2/test_g2_snap" or snap.filename == "testdata\gadget2\test_g2_snap.0"
...
def test_units_override():
    ...
    assert f.filename == "testdata/gadget2/test_g2_snap" or f.filename == "testdata\gadget2\test_g2_snap.0"
    ...
    assert f_no_unit_override.filename == "testdata/gadget2/test_g2_snap.1" or f_no_unit_override.filename == "testdata\gadget2\test_g2_snap.1"
