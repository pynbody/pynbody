...
def test_2D_shape():
  ...
  assert np.all(halo_shape[2] == [51987, 51953, 52368])
  npt.assert_allclose(np.abs(halo_shape[3]), [[[ 0.79139587, 0.61130399],
...
def test_3D_shape():
  ...
  assert np.all(halo_shape[2] == [50179, 50298, 50153])
  print(repr(halo_shape[3]))
  npt.assert_allclose(halo_shape[3], [[[ 0.57289184, -0.79477302, -0.20032668],
